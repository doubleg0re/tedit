# tedit detailed reference

This is the long-form CLI and MCP reference moved out of the root README. Start with the root README for installation and the common MCP workflow.
